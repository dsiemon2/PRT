...
**Reference Implementation**: `/admin/purchase-orders`
...
This document defines the standard behavior for all data grids and tables across the Pecos River Traders admin interfaces. All tables should follow these patterns for consistency.

### Reference Implementation

The **Purchase Orders** page (`/admin/purchase-orders`) serves as the canonical reference for grid behavior. When in doubt, match this page's behavior.
...
<button class="btn btn-outline-success" onclick="approveItem({{ $item->id }})" title="Approve this item">
...
var serverItems = @json($items['data'] ?? []);
...
- [CODING_STANDARDS.md](../../../PRT2/docs/CODING_STANDARDS.md) - General coding standards
