...
<div class="row">
    <div class="col-lg-8">
        <form class="admin-form">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <textarea class="form-control" rows="4" placeholder="Internal notes about this Supplier..."></textarea>
                </div>
            </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <h6>API Keys</h6>
                <p class="small text-muted">API keys will be generated automatically after the Supplier is created. You can regenerate keys from the detail page.</p>

                <h6>Webhooks</h6>
                <p class="small text-muted">Suppliers can configure webhooks to receive real-time updates about inventory changes and order status.</p>

                <h6>Permissions</h6>
                <p class="small text-muted">Carefully select which API endpoints the Supplier can access. Order creation should only be enabled for trusted partners.</p>
            </div>
        </div>
    </div>
</div>
